        ...
        <div class="content">
            ...
            <div class="input username">
                <svg xmlns="http://www.w3.org/2000/svg" width="38" height="40" viewBox="0 0 38 40" fill="none" class="img-form">
                    <path d="M29.6133 30.0156C27.973 27.0156 24.893 25 21.375 25H16.625C13.107 25 10.027 27.0156 8.38672 30.0156C10.9992 33.0781 14.7844 35 19 35C23.2156 35 27.0008 33.0703 29.6133 30.0156ZM0 20C0 14.6957 2.00178 9.60859 5.56497 5.85786C9.12816 2.10714 13.9609 0 19 0C24.0391 0 28.8718 2.10714 32.435 5.85786C35.9982 9.60859 38 14.6957 38 20C38 25.3043 35.9982 30.3914 32.435 34.1421C28.8718 37.8929 24.0391 40 19 40C13.9609 40 9.12816 37.8929 5.56497 34.1421C2.00178 30.3914 0 25.3043 0 20ZM19 21.25C20.4172 21.25 21.7765 20.6574 22.7786 19.6025C23.7807 18.5476 24.3438 17.1168 24.3438 15.625C24.3438 14.1332 23.7807 12.7024 22.7786 11.6475C21.7765 10.5926 20.4172 10 19 10C17.5828 10 16.2235 10.5926 15.2214 11.6475C14.2193 12.7024 13.6562 14.1332 13.6562 15.625C13.6562 17.1168 14.2193 18.5476 15.2214 19.6025C16.2235 20.6574 17.5828 21.25 19 21.25Z" fill="#902724"/>
                </svg>

            ...
            <div class="left">
                ...
                <script>
                    document.getElementById('fav').addEventListener('click', function() {
                        alert('Film telah ditambahkan ke favorit!');
                    });
                </script>
            </div>
            <div class="right">
